...
def main():
    ...
    card_dict[card1] = True
    card_dict[card2] = True
    
    # Blackjack case
    if value == 21:
        print("Your current value is Blackjack! (21)")
        print("with the hand: ", ", ".join(card_dict.keys()), "\n")
    else:
    ...
    d_card_dict[d_card1] = True
    d_card_dict[d_card2] = True
    
    # Blackjack case
    if d_value == 21:
        print("Dealer's current value is Blackjack! (21)")
        print("with the hand: ", ", ".join(d_card_dict.keys()), "\n")
    # Bust case
    else:
